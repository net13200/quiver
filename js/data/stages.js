...
export const STAGES = [
    ...
    },
    {
        ...
        levels: [
            {
                name: "4.1: SWAP Gate",
                quizDesc: "Swap q1 (|+⟩) and q2 (|1⟩) using three CX gates",
                circuits: [
            ...
            },
            {
                ...
                quizDesc: "Implement CSWAP (ctrl: q0, targets: q1 ↔ q2) using three Toffoli gates",
            ...
            },
            {
                ...
                quizDesc: "Implement CSWAP (ctrl: q0, targets: q1 ↔ q2) using 1 Toffoli and 2 CX gates",
                set: ['X0','X1','X2', 'H0','H1','H2', 'CX01','CX10','CX12','CX21', 'CX02', 'CX20', 'CCX012', 'CCX021'],
        ...
        levels: [
            {
                ...
                quizDesc: "Run the Swap Test on two identical states — prepare q1 = |+⟩ and q2 = |+⟩",
            ...
            },
            {
                ...
                quizDesc: "Run the Swap Test on orthogonal states — prepare q1 = |1⟩, q2 = |0⟩",
            ...
            },
            {
                ...
                quizDesc: "Run the Swap Test on partially overlapping states — prepare q1 = |+⟩, q2 = |0⟩",
        ...
        levels: [
            {
                ...
                quizDesc: "Measure the XX parity of (|01⟩ − |10⟩)/√2 using the Hadamard Test",
            ...
            },
            {
                ...
                quizDesc: "Measure the ZZ parity of (|01⟩ + |10⟩)/√2 using the Hadamard Test",
    ...
    },
    {
        ...
        levels: [
            {
                name: "7.1: S Gate (π/2)",
                quizDesc: "Apply the S gate — put q0 in |+⟩ then rotate its phase by π/2",
            ...
            {
                name: "7.2: T Gate (π/4)",
                quizDesc: "Apply the T gate — put q0 in |+⟩ then rotate its phase by π/4",
            ...
            },
            {
                ...
                quizDesc: "Implement an X gate using T·T·S rotations: H → Rz(π/4) → Rz(π/4) → Rz(π/2) → H",
            ...
            },
            {
                ...
                quizDesc: "Decompose a CP(π/2) gate on q0 and q1 using Rz(π/4) rotations and CX gates",
        ...
        levels: [
            {
                ...
                quizDesc: "Implement the 1-qubit QFT",
                circuits: [[['H0']]],
            ...
            },
            {
                ...
                quizDesc: "Implement the 2-qubit QFT on q0 and q1",
            ...
            },
            {
                ...
                quizDesc: "Implement the 3-qubit QFT on q0, q1, and q2",
    ...
    },
    {
        ...
        levels: [
            {
                name: "QFT Adder (+1)",
                quizDesc: "Use the QFT Adder to compute |1⟩ + 1 — prepare |1⟩, apply QFT, add phase shifts for +1, apply IQFT",
            ...
            {
                name: "QFT Adder (+2)",
                quizDesc: "Use the QFT Adder to compute |1⟩ + 2 — prepare |1⟩, apply QFT, add phase shifts for +2, apply IQFT",
            ...
            {
                name: "QFT Adder (+3)",
                quizDesc: "Use the QFT Adder to compute |1⟩ + 3 — prepare |1⟩, apply QFT, add phase shifts for +3, apply IQFT",
            ...
            },
            {
                ...
                quizDesc: "Add +2 to (|0⟩+|1⟩)/√2 using the QFT Adder — both values incremented simultaneously",
                set: ['H', 'X', 'QFT', 'IQFT', 'RZ'],
        ...
        levels: [
            {
                ...
                quizDesc: "Estimate the phase of the S gate (φ = ¼) using Quantum Phase Estimation",
        ...
        levels: [
            {
                ...
                quizDesc: "Demonstrate phase kickback — flip q0 to |1⟩ by applying CX into |−⟩ on q2",
                set: ['H0', 'H2', 'X2', 'CX02'],
            ...
            },
            {
                ...
                quizDesc: "Build the Grover oracle — mark |111⟩ with a −1 phase using H and CCX gates",
                set: ['H0', 'H1', 'H2', 'CCX012'],
            ...
            },
            {
                ...
                quizDesc: "Run one full iteration of Grover's Algorithm to amplify |111⟩ from 12.5% to ~78%",
