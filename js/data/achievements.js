...
export const ACHIEVEMENTS = [
    ...
    { id: 'stage_12_complete',  name: 'Parameter Pioneer',    icon: '⚡', desc: 'Complete Stage 12: Parametrized Circuits',   category: 'Learning' },
    { id: 'stage_13_complete',  name: 'Variationalist',       icon: '⚗️', desc: 'Complete Stage 13: VQE',                    category: 'Learning' },
    { id: 'stage_14_complete',  name: 'QAOA Champion',        icon: '🏆', desc: 'Complete Stage 14: QAOA',                   category: 'Learning' },
